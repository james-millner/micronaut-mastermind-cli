...
internal class MastermindActions {
    ...
    fun submitPlayersGuess(playerPegChoice: List<Peg>, secretCode: List<Peg>): MastermindResult {

        val matchedResults = determineCorrectGuesses(playerPegChoice, secretCode)
    ...
    fun determineCorrectGuesses(playerPegChoice: List<Peg>, secretCode: List<Peg>): List<Pair<Boolean, Boolean>> {
